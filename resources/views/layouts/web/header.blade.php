<header class="relative w-full mt-10 z-50">
    ...
    <div id="mobileMenu" class="hidden lg:hidden mt-10">
      <nav class="flex flex-col space-y-4 p-2 text-[20px] font-regular mt-[60px] text-[var(--text-color)]">
        ...
        <a href="{{ route('register') }}" class="bg-[#4682B4] text-white text-center py-2 rounded-full">
          Sign Up
        </a>
      </nav>
    </div>
