            ...
            <div data-aos="fade-right">
                ...
                <div class="space-y-8">
                    ...
                    <div class="flex items-start gap-6 group">
                        <div class="w-16 h-16 bg-(--primary-color)/10 rounded-[20px] flex items-center justify-center group-hover:bg-(--primary-color) transition-colors duration-300">
                            <i class="fas fa-envelope text-2xl text-(--primary-color) group-hover:text-white transition-colors"></i>
                        </div>
                        <div>
                            <h4 class="text-xl font-bold mb-2 text-(--text-color)">Email Us</h4>
                            <p class="text-gray-500 mb-1">General Inquiries</p>
                    ...
                    <div class="flex items-start gap-6 group">
                        ...
                        <div>
                            <h4 class="text-xl font-bold mb-2 text-(--text-color)">Call Us</h4>
                            <p class="text-gray-500 mb-1">Mon-Fri from 8am to 5pm</p>
                    ...
                    <div class="flex items-start gap-6 group">
                        ...
                        <div>
                            <h4 class="text-xl font-bold mb-2 text-(--text-color)">Visit Us</h4>
                ...
                <div class="mt-12">
                    ...
                    <div class="flex gap-4">
                        <a href="#" class="w-12 h-12 rounded-full border border-gray-200 flex items-center justify-center text-gray-400 hover:bg-(--primary-color) hover:border-(--primary-color) hover:text-white transition-all">
                    ...
                    <form action="#" class="space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-2">
                                ...
                                <input type="text" placeholder="John" class="w-full px-6 py-4 rounded-2xl bg-gray-50 border border-transparent focus:bg-white focus:border-(--primary-color) outline-none transition-all">
                            </div>
                            <div class="space-y-2">
                                <label class="text-sm font-bold text-gray-700 ml-1">Last Name</label>
                                <input type="text" placeholder="Doe" class="w-full px-6 py-4 rounded-2xl bg-gray-50 border border-transparent focus:bg-white focus:border-(--primary-color) outline-none transition-all">
                            </div>
                        </div>

                        <div class="space-y-2">
                            <label class="text-sm font-bold text-gray-700 ml-1">Email Address</label>
                            <input type="email" placeholder="john@example.com" class="w-full px-6 py-4 rounded-2xl bg-gray-50 border border-transparent focus:bg-white focus:border-(--primary-color) outline-none transition-all">
                        </div>

                        <div class="space-y-2">
                            <label class="text-sm font-bold text-gray-700 ml-1">Subject</label>
                            <select class="w-full px-6 py-4 rounded-2xl bg-gray-50 border border-transparent focus:bg-white focus:border-(--primary-color) outline-none transition-all appearance-none cursor-pointer">
                        ...
                        <div class="space-y-2">
                            ...
                            <textarea rows="5" placeholder="How can we help you?" class="w-full px-6 py-4 rounded-2xl bg-gray-50 border border-transparent focus:bg-white focus:border-(--primary-color) outline-none transition-all resize-none"></textarea>
                        </div>
    ...
    <section class="bg-[#F8FAFC] py-24 mb-20">
        <div class="container mx-auto px-4">
            ...
            <div class="max-w-3xl mx-auto space-y-4">
                <!-- FAQ 1 -->
                <div class="faq-item bg-white rounded-[20px] p-6 shadow-sm cursor-pointer hover:shadow-md transition-all">
                    <div class="faq-header flex justify-between items-center group">
                        <h4 class="font-bold text-lg text-(--text-color) group-hover:text-(--primary-color) transition-colors">How do I become a host?</h4>
                ...
                <div class="faq-item bg-white rounded-[20px] p-6 shadow-sm cursor-pointer hover:shadow-md transition-all">
                    <div class="faq-header flex justify-between items-center group">
                        <h4 class="font-bold text-lg text-(--text-color) group-hover:text-(--primary-color) transition-colors">Is my payment secure?</h4>
                        <i class="fas fa-chevron-down text-gray-400 transition-transform duration-300"></i>
                    </div>
                    <div class="faq-body hidden pt-4 border-t border-gray-100 mt-4">
                        <p class="text-gray-500 leading-relaxed">
                ...
                <div class="faq-item bg-white rounded-[20px] p-6 shadow-sm cursor-pointer hover:shadow-md transition-all">
                    <div class="faq-header flex justify-between items-center group">
                        <h4 class="font-bold text-lg text-(--text-color) group-hover:text-(--primary-color) transition-colors">Can I cancel a booking?</h4>
                        <i class="fas fa-chevron-down text-gray-400 transition-transform duration-300"></i>
                    </div>
                    <div class="faq-body hidden pt-4 border-t border-gray-100 mt-4">
                        <p class="text-gray-500 leading-relaxed">
                ...
                <div class="faq-item bg-white rounded-[20px] p-6 shadow-sm cursor-pointer hover:shadow-md transition-all">
                    <div class="faq-header flex justify-between items-center group">
                        <h4 class="font-bold text-lg text-(--text-color) group-hover:text-(--primary-color) transition-colors">What if I damage equipment?</h4>
                        <i class="fas fa-chevron-down text-gray-400 transition-transform duration-300"></i>
                    </div>
                    <div class="faq-body hidden pt-4 border-t border-gray-100 mt-4">
                        <p class="text-gray-500 leading-relaxed">
