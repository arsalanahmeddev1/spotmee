                                    ...
                                    <tbody>
                                        @forelse ($hosts as $host)
                                            <tr class="product-removes inbox-data">
                                                <td><a href="user-profile.html">{{ $host->name }}</a></td>
                                                <td>
                                                    <p>{{ $host->email }}</p>
                                                </td>
                                                <td>
                                                    <span
                                                        class="badge badge-light-success">{{ $host->roles->first()->name }}</span>
                                                </td>
                                                <td>
                                                    <p>{{ $host->created_at->format('d M Y, H:i A') }}</p>
                                                </td>
                                                {{-- <td>
                                                ...
                                                <td>
                                                    <div class="form-check form-switch form-check-inline custom-switch ps-0">
                                                        <select class="form-select approval-select"
                                                            data-id="{{ $host->id }}"
                                                            data-current="{{ $host->approval_status }}">
                                                            <option value="pending"
                                                                {{ $host->approval_status === 'pending' ? 'selected' : '' }}>
                                                                Pending
                                                            </option>
                                                            <option value="approved"
                                                                {{ $host->approval_status === 'approved' ? 'selected' : '' }}>
                                                                Approved
                                                            </option>
                                                            <option value="rejected"
                                                                {{ $host->approval_status === 'rejected' ? 'selected' : '' }}>
                                                                Rejected
                                                            </option>
                                                        </select>
                                                    </div>
